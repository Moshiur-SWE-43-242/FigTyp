...
import { 
  ...
  CheckCircle, AlertTriangle, Eye, Upload, Key, Zap, Flame, Lock, ChevronRight, Check
} from 'lucide-react';
          ...
          {activeTab === 'BRANDING' && (
            <div className="space-y-8 max-w-6xl mx-auto">
              <div>
                ...
                <p className="text-sm text-slate-400 font-mono mt-1">Configure website logo, partner brand logos, founder picture, and certificate signatures.</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 font-mono text-xs">
                ...
                <div className="p-5 rounded-2xl bg-slate-900/40 border border-slate-800 space-y-3">
                  <h4 className="font-bold text-white text-sm">FigTyp Brand Logo</h4>
                  {logoInput && (
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-cyan-500 hover:bg-cyan-400 text-black font-bold rounded-xl transition"
                  >
                    Save Logo
                  </button>
                </div>
                ...
                {/* M-Square Logo */}
                <div className="p-5 rounded-2xl bg-slate-900/40 border border-slate-800 space-y-3">
                  <h4 className="font-bold text-white text-sm">M-Square Devs Logo</h4>
                  {mSquareInput && (
                ...
                {/* MiraCore Logo */}
                <div className="p-5 rounded-2xl bg-slate-900/40 border border-slate-800 space-y-3">
                  <h4 className="font-bold text-white text-sm">MiraCore Logix Logo</h4>
                  {miraCoreInput && (
                ...
                {/* Founder Picture */}
                <div className="p-5 rounded-2xl bg-slate-900/40 border border-slate-800 space-y-3">
                  <h4 className="font-bold text-white text-sm">Founder Profile Picture & Dimension</h4>
                  {founderPicInput && (
                    <img src={founderPicInput} alt="Founder" style={{ width: founderPicSize, height: founderPicSize }} className="rounded-xl object-cover border border-slate-700 shadow-md" />
                  )}
                  <input
                    type="text"
                  ...
                  />
                  <div className="flex items-center gap-3">
                    <span className="text-slate-400 text-xs">Size: {founderPicSize}px</span>
                    <input
                      type="range"
                      min={32}
                      max={128}
